...
function buildAppUI() {
    ...
    <main class="flex-1 w-full max-w-5xl px-3 sm:px-4 flex flex-col justify-center items-center overflow-hidden relative">
        ...
        <section id="game-transition-stage" class="hidden w-full h-full flex flex-col justify-center items-center text-center p-6 rounded-[2.5rem] shadow-xl text-white bg-gradient-to-br from-indigo-500 to-purple-600 relative overflow-hidden shrink-0 z-20" role="dialog" aria-modal="true" aria-labelledby="transition-title">
            <h2 id="transition-title" class="text-3xl sm:text-5xl font-black text-yellow-300 drop-shadow-md mb-3 animate-bounce" data-i18n="amazing_job">${escapeHTML(i18n.t('amazing_job'))}</h2>
        ...
        <section id="wordwall-stage" class="hidden w-full h-full flex flex-col items-center py-3 px-2 overflow-hidden bg-slate-50 rounded-3xl border border-slate-200 shadow-inner">
            <div class="w-full max-w-4xl flex flex-col sm:flex-row justify-between items-center mb-3 shrink-0 gap-3 px-3">
                ...
                <nav role="tablist" data-i18n-aria="games_room_title" aria-label="${escapeHTML(i18n.t('games_room_title'))}" class="bg-white p-1 rounded-2xl shadow-sm border border-slate-200 flex flex-wrap gap-1">
${wordwallTabsHtml}
                </nav>
            </div>
                ...
                <div id="ww-ladder-container" role="tabpanel" aria-labelledby="tab-ladder" class="hidden w-full h-full flex flex-col items-center justify-between p-2 max-w-4xl mx-auto overflow-y-auto custom-scrollbar" data-i18n-aria="aria_ladder_game" aria-label="${escapeHTML(i18n.t('aria_ladder_game'))}">
                    ...
                    <div class="w-full max-w-md shrink-0 space-y-2 pb-1">
                        <div class="grid grid-cols-2 gap-3">
                            ...
                            <button onclick="ladderGame.grade(true)" class="bg-emerald-500 hover:bg-emerald-600 text-white py-3 rounded-2xl text-base font-black shadow-[0_4px_0_#047857] active:translate-y-1 active:shadow-none transition-all flex items-center justify-center gap-2" data-i18n-aria="aria_step_up" aria-label="${escapeHTML(i18n.t('aria_step_up'))}">
        ...
        <div id="word-overlay" class="hidden fixed inset-0 bg-slate-900/80 z-50 flex flex-col justify-center items-center p-3 sm:p-6 backdrop-blur-md" role="dialog" aria-modal="true" aria-labelledby="revealed-info">
            <div class="giant-word-overlay bg-white rounded-[2.5rem] w-full max-w-3xl max-h-[90vh] p-5 sm:p-8 flex flex-col justify-between items-center shadow-2xl border-4 border-emerald-400 overflow-y-auto custom-scrollbar">
                <div class="w-full flex justify-between items-center px-2 shrink-0 mb-3">
                    ...
                    <button onclick="app.closeOverlay()" class="bg-slate-100 text-slate-500 hover:bg-rose-100 hover:text-rose-600 px-3.5 py-1 rounded-full text-xs font-black transition-colors" data-i18n-aria="close" aria-label="${escapeHTML(i18n.t('close'))}">✕ <span data-i18n="close">${escapeHTML(i18n.t('close'))}</span></button>
                </div>
...
if (typeof window !== 'undefined') {
    window.addEventListener('nb:locale-changed', updateDynamicLessonUI);
